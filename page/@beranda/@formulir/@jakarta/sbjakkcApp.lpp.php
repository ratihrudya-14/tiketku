        ...
        <?php
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                if($check > 0){
                    ...
                    header("Location: ../../@pembayaran/@jakarta/sbjakkc");
                }
            }
        ?>
    </head>
            ...
            <div class="c2" id="c2">
                <div class="c2-form" id="c2-form">
                    <form action="" method="post">
                        ...
                        <div class="c2-form-input" id="c2-form-input">
                            <input class="c2-form-input-c" id="c2-form-input-c" type="text" placeholder="..." value="SBJAKKC" readonly name="ticket" autofocus autocomplete="off" required>
                        </div>
