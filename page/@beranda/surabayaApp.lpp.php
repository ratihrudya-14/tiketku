    ...
    <head>
        ...
        <style type="text/css">
            ...
            .page .page-c .c .c2 .c2-1 .c2-1-banner {
                background: url('../../assets/ivg/surabaya.jpg') no-repeat;
                background-size: 100%;
        ...
        <script type="text/javascript">
            ...
            function yksbcPage(){
                window.location = "@formulir/@surabaya/yksbc";
            }
            function yksbaPage(){
                window.location = "@formulir/@surabaya/yksba";
            }
        </script>
        <?php
        ...
        <div class="c" id="c">
            ...
            <div class="c2" id="c2">
                ...
                <div class="c2-2" id="c2-2">
                    <div class="c2-2-post" id="c2-2-post" onclick="yksbcPage()">
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-text" id="c2-2-post-c-text"><strong>Yogyakarta (YK)</strong> ke <strong>Surabaya (SB)</strong></p>
                        </div>
                        <div class="c2-2-post-c" id="c2-2-post-c">
                    ...
                    <div class="c2-2-post" id="c2-2-post" onclick="yksbaPage()">
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-text" id="c2-2-post-c-text"><strong>Yogyakarta (YK)</strong> ke <strong>Surabaya (SB)</strong></p>
                        </div>
                        <div class="c2-2-post-c" id="c2-2-post-c">
