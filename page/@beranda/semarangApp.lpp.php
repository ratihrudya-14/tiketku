    ...
    <head>
        ...
        <style type="text/css">
            ...
            .page .page-c .c .c2 .c2-1 .c2-1-banner {
                background: url('../../assets/ivg/semarang.jpg') no-repeat;
                background-size: 100%;
        ...
        <script type="text/javascript">
            ...
            function jakksmccPage(){
                window.location = "@formulir/@semarang/jakksmcc";
            }
            function yksmccPage(){
                window.location = "@formulir/@semarang/yksmcc";
            }
            function yksmcaPage(){
                window.location = "@formulir/@semarang/yksmca";
            }
            function mnsmccPage(){
                window.location = "@formulir/@semarang/mnsmcc";
            }
        ...
        <div class="c" id="c">
            <div class="c1" id="c1">
                <div class="c1-c c1-c-left" id="c1-c c1-c-left">
                    <h1 class="c1-c-text" id="c1-c-text">Semarang</h1>
                </div>
            ...
            <div class="c2" id="c2">
                ...
                <div class="c2-2" id="c2-2">
                    <div class="c2-2-post" id="c2-2-post" onclick="jakksmccPage()">
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-text" id="c2-2-post-c-text"><strong>Jakarta (JAKK)</strong> ke <strong>Semarang (SMC)</strong></p>
                        </div>
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-time" id="c2-2-post-c-time"><strong><?php echo "$date"; ?></strong><br><?php echo "$jakktime";?> WIB</p>
                        </div>
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-price" id="c2-2-post-c-price"><strong>Ekonomi (C)</strong><br>Rp. 250,000</p>
                        </div>
                    </div>
                    <div class="c2-2-post" id="c2-2-post" onclick="yksmccPage()">
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-text" id="c2-2-post-c-text"><strong>Yogyakarta (YK)</strong> ke <strong>Semarang (SMC)</strong></p>
                        </div>
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-time" id="c2-2-post-c-time"><strong><?php echo "$date"; ?></strong><br><?php echo "$yktime";?> WIB</p>
                        </div>
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-price" id="c2-2-post-c-price"><strong>Ekonomi (C)</strong><br>Rp. 165,000</p>
                        </div>
                    </div>
                    <div class="c2-2-post" id="c2-2-post" onclick="yksmcaPage()">
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-text" id="c2-2-post-c-text"><strong>Yogyakarta (YK)</strong> ke <strong>Semarang (SMC)</strong></p>
                        </div>
                        <div class="c2-2-post-c" id="c2-2-post-c">
                        ...
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-price" id="c2-2-post-c-price"><strong>Eksekutif (A)</strong><br>Rp. 275,000</p>
                        </div>
                    </div>
                    <div class="c2-2-post" id="c2-2-post" onclick="mnsmccPage()">
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-text" id="c2-2-post-c-text"><strong>Madiun (MN)</strong> ke <strong>Semarang (SMC)</strong></p>
                        </div>
                        <div class="c2-2-post-c" id="c2-2-post-c">
