    ...
    <head>
        ...
        <?php
            ...
            if($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                $data = mysqli_query($conn, "SELECT * FROM payment WHERE card='$card' && valid='$valid'");
                $check = mysqli_num_rows($data);
                if($check > 0){
                    header("Location: ");
                } else {
                    mysqli_query($conn, "INSERT INTO ticket VALUES('', '$card', '$valid')");
                    header("Location: ../../");
                }
            }
        ?>
        ...
        <div class="c" id="c">
            <div class="c1" id="c1">
                <div class="c1-c c1-c-left" id="c1-c c1-c-left">
                    <h1 class="c1-c-text" id="c1-c-text">Yogyakarta</h1>
                </div>
                <div class="c1-c c1-c-right" id="c1-c c1-c-right">
                    <button class="c1-c-button" id="c1-c-button" onclick="yogyakartaPage()">KEMBALI</button>
                </div>
            </div>
            <div class="c2" id="c2">
                <div class="c2-form" id="c2-form">
                    <form action="" method="post">
                        <div class="c2-form-input" id="c2-form-input">
                            <input class="c2-form-input-c" id="c2-form-input-c" type="number" placeholder="Rekening" name="card" autofocus autocomplete="off" required>
                        </div>
                        <div class="c2-form-input" id="c2-form-input">
                            <input class="c2-form-input-c" id="c2-form-input-c" type="number" placeholder="Berlaku sampai..." name="valid" autofocus autocomplete="off" required>
                        </div>
                        <button class="c2-form-button" id="c2-form-button" type="submit" name="submit">Selesaikan</button>
                    </form>
                </div>
            </div>
        </div>
