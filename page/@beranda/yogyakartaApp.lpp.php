    ...
    <head>
        ...
        <style type="text/css">
            ...
            .page .page-c .c .c2 .c2-1 .c2-1-banner {
                background: url('../../assets/ivg/yogyakarta.jpg') no-repeat;
                background-size: 100%;
        ...
        <script type="text/javascript">
            ...
            function smcykcPage(){
                window.location = "@formulir/@yogyakarta/smcykc";
            }
            function smcykaPage(){
                window.location = "@formulir/@yogyakarta/smcyka";
            }
        </script>
        <?php
        ...
        <div class="c" id="c">
            ...
            <div class="c2" id="c2">
                ...
                <div class="c2-2" id="c2-2">
                    <div class="c2-2-post" id="c2-2-post" onclick="smcykcPage()">
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-text" id="c2-2-post-c-text"><strong>Semarang (SMC)</strong> ke <strong>Yogyakarta (YK)</strong></p>
                        </div>
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-time" id="c2-2-post-c-time"><strong><?php echo "$date"; ?></strong><br><?php echo "$yktime";?> WIB</p>
                        </div>
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-price" id="c2-2-post-c-price"><strong>Ekonomi (C)</strong><br>Rp. 318,000</p>
                        </div>
                    </div>
                    <div class="c2-2-post" id="c2-2-post" onclick="smcykaPage()">
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-text" id="c2-2-post-c-text"><strong>Semarang (SMC)</strong> ke <strong>Yogyakarta (YK)</strong></p>
                        </div>
                        <div class="c2-2-post-c" id="c2-2-post-c">
                        ...
                        <div class="c2-2-post-c" id="c2-2-post-c">
                            <p class="c2-2-post-c-price" id="c2-2-post-c-price"><strong>Eksekutif (A)</strong><br>Rp. 408,000</p>
                        </div>
                    </div>
                </div>
            </div>
